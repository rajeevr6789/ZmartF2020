...
<!--Calling header content-->
	...
	<?php $this->load->view('smart_header');?>
	
        <!-- page content -->
        <div class="right_col" role="main">
          <!-- top tiles -->
		<!--Small box colored status-->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Melt Temperature-Time</h3>
                  </div>
                  <div class="col-md-6">
                    <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                      <span>
					  Melt Temperature - Time</span> <b class="caret"></b>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 bg-white">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-6">
                    <div>
                      ...
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
                          <div class="progress-bar bg-yellow" role="progressbar" data-transitiongoal="40"></div>
                        </div>
                      </div>
                    </div>
                    <div>
...
<table>
			...
			<tr>
			<td>Layout Name</td>
			<td>10PADIMPORTBYASFEEDER</td>
			<td>Cast Metal</td>
			<td>Cast Steel - WCB</td>
			</tr>
			<tr>
			...
			<td>1094 mm X 300 mm X 1094 mm</td>
			<td>Part Surface Area</td>
			<td>3.34 m²</td>
			</tr>
			<tr>
			<td>Part Weight</td>
